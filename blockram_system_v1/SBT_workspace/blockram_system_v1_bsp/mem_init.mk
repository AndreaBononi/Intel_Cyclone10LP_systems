...
# Memory: instruction_OCRAM
MEM_0 := blockram_system_v1_instruction_OCRAM
$(MEM_0)_NAME := instruction_OCRAM
...
$(MEM_0)_HIERARCHICAL_PATH := instruction_OCRAM
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: instruction_OCRAM
instruction_OCRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
