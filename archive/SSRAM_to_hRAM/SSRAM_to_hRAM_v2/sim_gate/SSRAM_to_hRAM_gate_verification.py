...
simulation_project = "SSRAM_to_hRAM (gate-level)"
...
simulation_file = "SSRAM_to_hRAM_run_msim_gate_vhdl.do"
...
try:
    ...
    if ( dstat.read(1) == '0' ):
        ...
        subprocess.run( "rm -r transcript gate_work/ __pycache__/ vsim.wlf modelsim.ini", shell=True )
