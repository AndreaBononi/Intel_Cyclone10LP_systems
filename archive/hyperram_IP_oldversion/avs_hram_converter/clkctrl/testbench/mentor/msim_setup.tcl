...
# ----------------------------------------
# If clkctrl_tb is one of several IP cores in your
...
# ----------------------------------------
# ACDS 22.1 917 linux 2023.12.14.10:18:50
...
ensure_lib              ./libraries/clkctrl_inst/
vmap       clkctrl_inst ./libraries/clkctrl_inst/
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clkctrl_tb/simulation/submodules/clkctrl_altclkctrl_0.vhd" -work altclkctrl_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clkctrl_tb/simulation/submodules/clkctrl.vhd"              -work clkctrl_inst
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clkctrl_tb/simulation/clkctrl_tb.vhd"                                        
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altclkctrl_0 -L clkctrl_inst -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclone10lp $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -voptargs=+acc -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altclkctrl_0 -L clkctrl_inst -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclone10lp $TOP_LEVEL_NAME
}
