...
module  avs_hram_converter_TEST_basic_avs_hram_converter_inst_clkctrl_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //avs_hram_converter_TEST_basic_avs_hram_converter_inst_clkctrl_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  avs_hram_converter_TEST_basic_avs_hram_converter_inst_clkctrl_altclkctrl_0  (
    ena,
    inclk,
    outclk);
...
`endif
    ...
    avs_hram_converter_TEST_basic_avs_hram_converter_inst_clkctrl_altclkctrl_0_sub  avs_hram_converter_TEST_basic_avs_hram_converter_inst_clkctrl_altclkctrl_0_sub_component (
                .ena (ena),
                .inclk (sub_wire2),
                .outclk (sub_wire0));
