...
mkdir -p ./libraries/clkctrl_inst/
...
if [ $SKIP_COM -eq 0 ]; then
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clkctrl_tb/simulation/submodules/clkctrl_altclkctrl_0.vhd" -work altclkctrl_0 -cdslib ./cds_libs/altclkctrl_0.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clkctrl_tb/simulation/submodules/clkctrl.vhd"              -work clkctrl_inst -cdslib ./cds_libs/clkctrl_inst.cds.lib
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clkctrl_tb/simulation/clkctrl_tb.vhd"                                                                                
fi
