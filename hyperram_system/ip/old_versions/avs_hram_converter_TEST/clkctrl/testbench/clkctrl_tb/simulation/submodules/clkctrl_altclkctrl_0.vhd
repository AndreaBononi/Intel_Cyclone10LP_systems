...
--synthesis_resources = clkctrl 1 
 ...
 ENTITY  clkctrl_altclkctrl_0_sub IS 
	 PORT 
	 ( 
		 ena	:	IN  STD_LOGIC := '1';
 ...
 END clkctrl_altclkctrl_0_sub;

 ARCHITECTURE RTL OF clkctrl_altclkctrl_0_sub IS
 ...
 END RTL; --clkctrl_altclkctrl_0_sub
...
ENTITY clkctrl_altclkctrl_0 IS
    PORT
    (
        ena       : IN STD_LOGIC  := '1';
        inclk       : IN STD_LOGIC;
...
END clkctrl_altclkctrl_0;


ARCHITECTURE RTL OF clkctrl_altclkctrl_0 IS
    ...
    COMPONENT  clkctrl_altclkctrl_0_sub
    PORT (
            ena : IN STD_LOGIC;
            inclk   : IN STD_LOGIC_VECTOR  (3 DOWNTO 0);
            outclk  : OUT STD_LOGIC
...
BEGIN
    ...
    clkctrl_altclkctrl_0_sub_component : clkctrl_altclkctrl_0_sub
    PORT MAP (
        ena => ena,
        inclk => sub_wire2,
        outclk => sub_wire0
