...
# hram_CK is a clock path, not a data path ------------------------------------------------------
set_false_path -from [get_pins {EU|clk_gater_inst|altclkctrl_0|clkctrl_altclkctrl_0_sub_component|clkctrl1|outclk}] -to [get_ports {hram_CK}]
