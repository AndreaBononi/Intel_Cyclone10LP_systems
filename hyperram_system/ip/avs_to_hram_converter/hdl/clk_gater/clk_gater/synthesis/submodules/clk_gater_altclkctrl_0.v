//altclkctrl CBX_SINGLE_OUTPUT_FILE="ON" CLOCK_TYPE="External Clock Output" DEVICE_FAMILY="Cyclone 10 LP" ENA_REGISTER_MODE="double register" USE_GLITCH_FREE_SWITCH_OVER_IMPLEMENTATION="OFF" ena inclk outclk
...
module  clk_gater_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
endmodule //clk_gater_altclkctrl_0_sub
...
`endif
    ...
    clk_gater_altclkctrl_0_sub  clk_gater_altclkctrl_0_sub_component (
                .ena (ena),
                .inclk (sub_wire2),
                .outclk (sub_wire0));
