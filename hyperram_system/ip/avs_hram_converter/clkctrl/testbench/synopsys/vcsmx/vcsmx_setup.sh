...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clkctrl_tb/simulation/submodules/clkctrl_altclkctrl_0.vhd" -work altclkctrl_0
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clkctrl_tb/simulation/submodules/clkctrl.vhd"              -work clkctrl_inst
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clkctrl_tb/simulation/clkctrl_tb.vhd"                                        
fi
