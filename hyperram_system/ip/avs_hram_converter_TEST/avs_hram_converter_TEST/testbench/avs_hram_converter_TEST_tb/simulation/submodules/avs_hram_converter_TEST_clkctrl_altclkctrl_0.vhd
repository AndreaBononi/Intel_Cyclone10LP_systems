...
--synthesis_resources = clkctrl 1 
 ...
 ENTITY  avs_hram_converter_TEST_clkctrl_altclkctrl_0_sub IS 
	 PORT 
	 ( 
		 ena	:	IN  STD_LOGIC := '1';
 ...
 END avs_hram_converter_TEST_clkctrl_altclkctrl_0_sub;

 ARCHITECTURE RTL OF avs_hram_converter_TEST_clkctrl_altclkctrl_0_sub IS
 ...
 END RTL; --avs_hram_converter_TEST_clkctrl_altclkctrl_0_sub
...
ENTITY avs_hram_converter_TEST_clkctrl_altclkctrl_0 IS
    PORT
    (
        ena       : IN STD_LOGIC  := '1';
        inclk       : IN STD_LOGIC;
...
END avs_hram_converter_TEST_clkctrl_altclkctrl_0;


ARCHITECTURE RTL OF avs_hram_converter_TEST_clkctrl_altclkctrl_0 IS
    ...
    COMPONENT  avs_hram_converter_TEST_clkctrl_altclkctrl_0_sub
    PORT (
            ena : IN STD_LOGIC;
            inclk   : IN STD_LOGIC_VECTOR  (3 DOWNTO 0);
            outclk  : OUT STD_LOGIC
...
BEGIN
    ...
    avs_hram_converter_TEST_clkctrl_altclkctrl_0_sub_component : avs_hram_converter_TEST_clkctrl_altclkctrl_0_sub
    PORT MAP (
        ena => ena,
        inclk => sub_wire2,
        outclk => sub_wire0
