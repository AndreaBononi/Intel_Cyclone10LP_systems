...
module basic_system_mm_interconnect_0 (
	...
	wire         ocram_s1_agent_rp_valid;                                                     // OCRAM_s1_agent:rp_valid -> router_004:sink_valid
	wire  [72:0] ocram_s1_agent_rp_data;                                                      // OCRAM_s1_agent:rp_data -> router_004:sink_data
	wire         ocram_s1_agent_rp_ready;                                                     // router_004:sink_ready -> OCRAM_s1_agent:rp_ready
	wire         ocram_s1_agent_rp_startofpacket;                                             // OCRAM_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         ocram_s1_agent_rp_endofpacket;                                               // OCRAM_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         router_004_src_valid;                                                        // router_004:src_valid -> OCRAM_s1_rsp_width_adapter:in_valid
	wire  [72:0] router_004_src_data;                                                         // router_004:src_data -> OCRAM_s1_rsp_width_adapter:in_data
	wire         router_004_src_ready;                                                        // OCRAM_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire   [4:0] router_004_src_channel;                                                      // router_004:src_channel -> OCRAM_s1_rsp_width_adapter:in_channel
	wire         router_004_src_startofpacket;                                                // router_004:src_startofpacket -> OCRAM_s1_rsp_width_adapter:in_startofpacket
	wire         router_004_src_endofpacket;                                                  // router_004:src_endofpacket -> OCRAM_s1_rsp_width_adapter:in_endofpacket
	wire         ocram_s1_rsp_width_adapter_src_valid;                                        // OCRAM_s1_rsp_width_adapter:out_valid -> rsp_demux_002:sink_valid
	wire  [90:0] ocram_s1_rsp_width_adapter_src_data;                                         // OCRAM_s1_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	wire         ocram_s1_rsp_width_adapter_src_ready;                                        // rsp_demux_002:sink_ready -> OCRAM_s1_rsp_width_adapter:out_ready
	wire   [4:0] ocram_s1_rsp_width_adapter_src_channel;                                      // OCRAM_s1_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	wire         ocram_s1_rsp_width_adapter_src_startofpacket;                                // OCRAM_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_002:sink_startofpacket
	wire         ocram_s1_rsp_width_adapter_src_endofpacket;                                  // OCRAM_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_002:sink_endofpacket
	wire         cmd_mux_002_src_valid;                                                       // cmd_mux_002:src_valid -> OCRAM_s1_cmd_width_adapter:in_valid
	wire  [90:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> OCRAM_s1_cmd_width_adapter:in_data
	wire         cmd_mux_002_src_ready;                                                       // OCRAM_s1_cmd_width_adapter:in_ready -> cmd_mux_002:src_ready
	wire   [4:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> OCRAM_s1_cmd_width_adapter:in_channel
	wire         cmd_mux_002_src_startofpacket;                                               // cmd_mux_002:src_startofpacket -> OCRAM_s1_cmd_width_adapter:in_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                 // cmd_mux_002:src_endofpacket -> OCRAM_s1_cmd_width_adapter:in_endofpacket
	...
	wire         ocram_s1_agent_rdata_fifo_src_valid;                                         // OCRAM_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [17:0] ocram_s1_agent_rdata_fifo_src_data;                                          // OCRAM_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         ocram_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_002:in_0_ready -> OCRAM_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                           // avalon_st_adapter_002:out_0_valid -> OCRAM_s1_agent:rdata_fifo_sink_valid
	wire  [17:0] avalon_st_adapter_002_out_0_data;                                            // avalon_st_adapter_002:out_0_data -> OCRAM_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                           // OCRAM_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                           // avalon_st_adapter_002:out_0_error -> OCRAM_s1_agent:rdata_fifo_sink_error
	...
	basic_system_mm_interconnect_0_router_002 router_005 (
	...
	basic_system_mm_interconnect_0_router_002 router_006 (
	...
	basic_system_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_100MHz_clk_clk),                      //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_system_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_100MHz_clk_clk),                      //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_system_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_100MHz_clk_clk),                      //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_system_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_100MHz_clk_clk),                      //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_system_mm_interconnect_0_avalon_st_adapter_002 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
