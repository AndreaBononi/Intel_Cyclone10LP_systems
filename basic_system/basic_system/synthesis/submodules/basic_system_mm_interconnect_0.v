...
module basic_system_mm_interconnect_0 (
	...
	wire  [87:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> nios2_data_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                           // nios2_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [2:0] rsp_mux_src_channel;                                                         // rsp_mux:src_channel -> nios2_data_master_agent:rp_channel
	...
	wire  [87:0] rsp_mux_001_src_data;                                                        // rsp_mux_001:src_data -> nios2_instruction_master_agent:rp_data
	wire         rsp_mux_001_src_ready;                                                       // nios2_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire   [2:0] rsp_mux_001_src_channel;                                                     // rsp_mux_001:src_channel -> nios2_instruction_master_agent:rp_channel
	...
	wire  [88:0] jtag_uart_avalon_jtag_slave_agent_rf_source_data;                            // jtag_uart_avalon_jtag_slave_agent:rf_source_data -> jtag_uart_avalon_jtag_slave_agent_rsp_fifo:in_data
	...
	wire  [88:0] jtag_uart_avalon_jtag_slave_agent_rsp_fifo_out_data;                         // jtag_uart_avalon_jtag_slave_agent_rsp_fifo:out_data -> jtag_uart_avalon_jtag_slave_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_src_data;                                                            // cmd_mux:src_data -> jtag_uart_avalon_jtag_slave_agent:cp_data
	...
	wire  [88:0] nios2_debug_mem_slave_agent_rf_source_data;                                  // nios2_debug_mem_slave_agent:rf_source_data -> nios2_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [88:0] nios2_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios2_debug_mem_slave_agent_rsp_fifo:out_data -> nios2_debug_mem_slave_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> nios2_debug_mem_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                       // nios2_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [2:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> nios2_debug_mem_slave_agent:cp_channel
	...
	wire  [13:0] onchip_ram_s1_agent_m0_address;                                              // onchip_RAM_s1_agent:m0_address -> onchip_RAM_s1_translator:uav_address
	...
	wire  [88:0] onchip_ram_s1_agent_rf_source_data;                                          // onchip_RAM_s1_agent:rf_source_data -> onchip_RAM_s1_agent_rsp_fifo:in_data
	...
	wire  [88:0] onchip_ram_s1_agent_rsp_fifo_out_data;                                       // onchip_RAM_s1_agent_rsp_fifo:out_data -> onchip_RAM_s1_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> onchip_RAM_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                       // onchip_RAM_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [2:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> onchip_RAM_s1_agent:cp_channel
	...
	wire  [87:0] nios2_data_master_agent_cp_data;                                             // nios2_data_master_agent:cp_data -> router:sink_data
	...
	wire  [87:0] nios2_instruction_master_agent_cp_data;                                      // nios2_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [87:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                                   // jtag_uart_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [87:0] nios2_debug_mem_slave_agent_rp_data;                                         // nios2_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [87:0] onchip_ram_s1_agent_rp_data;                                                 // onchip_RAM_s1_agent:rp_data -> router_004:sink_data
	...
	basic_system_mm_interconnect_0_router_003 router_004 (
