...
# Memory: data_OCRAM
MEM_0 := basic_system_data_OCRAM
$(MEM_0)_NAME := data_OCRAM
...
$(MEM_0)_HIERARCHICAL_PATH := data_OCRAM
$(MEM_0)_WIDTH := 16
...
.PHONY: data_OCRAM
data_OCRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: instr_OCROM
MEM_1 := basic_system_instr_OCROM
$(MEM_1)_NAME := instr_OCROM
...
$(MEM_1)_END := 0x00004fff
$(MEM_1)_SPAN := 0x00001000
$(MEM_1)_HIERARCHICAL_PATH := instr_OCROM
$(MEM_1)_WIDTH := 16
...
.PHONY: instr_OCROM
instr_OCROM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
