...
module basic_system_mm_interconnect_0 (
	...
	wire  [88:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> nios2_data_master_agent:rp_data
	...
	wire  [88:0] rsp_mux_001_src_data;                                                        // rsp_mux_001:src_data -> nios2_instruction_master_agent:rp_data
	...
	wire  [89:0] nios2_debug_mem_slave_agent_rf_source_data;                                  // nios2_debug_mem_slave_agent:rf_source_data -> nios2_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [89:0] nios2_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios2_debug_mem_slave_agent_rsp_fifo:out_data -> nios2_debug_mem_slave_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_src_data;                                                            // cmd_mux:src_data -> nios2_debug_mem_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                           // nios2_debug_mem_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [3:0] cmd_mux_src_channel;                                                         // cmd_mux:src_channel -> nios2_debug_mem_slave_agent:cp_channel
	...
	wire  [71:0] ocram_s1_agent_rf_source_data;                                               // OCRAM_s1_agent:rf_source_data -> OCRAM_s1_agent_rsp_fifo:in_data
	...
	wire  [71:0] ocram_s1_agent_rsp_fifo_out_data;                                            // OCRAM_s1_agent_rsp_fifo:out_data -> OCRAM_s1_agent:rf_sink_data
	...
	wire  [89:0] switches_s1_agent_rf_source_data;                                            // switches_s1_agent:rf_source_data -> switches_s1_agent_rsp_fifo:in_data
	...
	wire  [89:0] switches_s1_agent_rsp_fifo_out_data;                                         // switches_s1_agent_rsp_fifo:out_data -> switches_s1_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> switches_s1_agent:cp_data
	...
	wire  [88:0] nios2_data_master_agent_cp_data;                                             // nios2_data_master_agent:cp_data -> router:sink_data
	...
	wire  [88:0] nios2_instruction_master_agent_cp_data;                                      // nios2_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [88:0] nios2_debug_mem_slave_agent_rp_data;                                         // nios2_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [70:0] ocram_s1_agent_rp_data;                                                      // OCRAM_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [88:0] switches_s1_agent_rp_data;                                                   // switches_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [70:0] ocram_s1_burst_adapter_source0_data;                                         // OCRAM_s1_burst_adapter:source0_data -> OCRAM_s1_agent:cp_data
	wire         ocram_s1_burst_adapter_source0_ready;                                        // OCRAM_s1_agent:cp_ready -> OCRAM_s1_burst_adapter:source0_ready
	wire   [3:0] ocram_s1_burst_adapter_source0_channel;                                      // OCRAM_s1_burst_adapter:source0_channel -> OCRAM_s1_agent:cp_channel
	...
	wire  [70:0] router_003_src_data;                                                         // router_003:src_data -> OCRAM_s1_rsp_width_adapter:in_data
	wire         router_003_src_ready;                                                        // OCRAM_s1_rsp_width_adapter:in_ready -> router_003:src_ready
	wire   [3:0] router_003_src_channel;                                                      // router_003:src_channel -> OCRAM_s1_rsp_width_adapter:in_channel
	...
	wire  [88:0] ocram_s1_rsp_width_adapter_src_data;                                         // OCRAM_s1_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire         ocram_s1_rsp_width_adapter_src_ready;                                        // rsp_demux_001:sink_ready -> OCRAM_s1_rsp_width_adapter:out_ready
	wire   [3:0] ocram_s1_rsp_width_adapter_src_channel;                                      // OCRAM_s1_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire  [88:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> OCRAM_s1_cmd_width_adapter:in_data
	wire         cmd_mux_001_src_ready;                                                       // OCRAM_s1_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> OCRAM_s1_cmd_width_adapter:in_channel
	...
	wire  [70:0] ocram_s1_cmd_width_adapter_src_data;                                         // OCRAM_s1_cmd_width_adapter:out_data -> OCRAM_s1_burst_adapter:sink0_data
	wire         ocram_s1_cmd_width_adapter_src_ready;                                        // OCRAM_s1_burst_adapter:sink0_ready -> OCRAM_s1_cmd_width_adapter:out_ready
	wire   [3:0] ocram_s1_cmd_width_adapter_src_channel;                                      // OCRAM_s1_cmd_width_adapter:out_channel -> OCRAM_s1_burst_adapter:sink0_channel
