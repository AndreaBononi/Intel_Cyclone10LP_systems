...
module basic_system_mm_interconnect_0 (
		...
		output wire [12:0] OCRAM_s1_address,                        //                          OCRAM_s1.address
		output wire        OCRAM_s1_write,                          //                                  .write
		input  wire [15:0] OCRAM_s1_readdata,                       //                                  .readdata
		output wire [15:0] OCRAM_s1_writedata,                      //                                  .writedata
		output wire [1:0]  OCRAM_s1_byteenable,                     //                                  .byteenable
		output wire        OCRAM_s1_chipselect,                     //                                  .chipselect
		output wire        OCRAM_s1_clken,                          //                                  .clken
		output wire [1:0]  rst_switch_s1_address,                   //                     rst_switch_s1.address
		input  wire [31:0] rst_switch_s1_readdata,                  //                                  .readdata
	...
	wire  [15:0] ocram_s1_agent_m0_readdata;                                                  // OCRAM_s1_translator:uav_readdata -> OCRAM_s1_agent:m0_readdata
	...
	wire  [14:0] ocram_s1_agent_m0_address;                                                   // OCRAM_s1_agent:m0_address -> OCRAM_s1_translator:uav_address
	wire   [1:0] ocram_s1_agent_m0_byteenable;                                                // OCRAM_s1_agent:m0_byteenable -> OCRAM_s1_translator:uav_byteenable
	...
	wire  [15:0] ocram_s1_agent_m0_writedata;                                                 // OCRAM_s1_agent:m0_writedata -> OCRAM_s1_translator:uav_writedata
	wire         ocram_s1_agent_m0_write;                                                     // OCRAM_s1_agent:m0_write -> OCRAM_s1_translator:uav_write
	wire   [1:0] ocram_s1_agent_m0_burstcount;                                                // OCRAM_s1_agent:m0_burstcount -> OCRAM_s1_translator:uav_burstcount
	wire         ocram_s1_agent_rf_source_valid;                                              // OCRAM_s1_agent:rf_source_valid -> OCRAM_s1_agent_rsp_fifo:in_valid
	wire  [73:0] ocram_s1_agent_rf_source_data;                                               // OCRAM_s1_agent:rf_source_data -> OCRAM_s1_agent_rsp_fifo:in_data
	...
	wire  [73:0] ocram_s1_agent_rsp_fifo_out_data;                                            // OCRAM_s1_agent_rsp_fifo:out_data -> OCRAM_s1_agent:rf_sink_data
	...
	wire  [31:0] rst_switch_s1_agent_m0_readdata;                                             // rst_switch_s1_translator:uav_readdata -> rst_switch_s1_agent:m0_readdata
	wire         rst_switch_s1_agent_m0_waitrequest;                                          // rst_switch_s1_translator:uav_waitrequest -> rst_switch_s1_agent:m0_waitrequest
	wire         rst_switch_s1_agent_m0_debugaccess;                                          // rst_switch_s1_agent:m0_debugaccess -> rst_switch_s1_translator:uav_debugaccess
	wire  [14:0] rst_switch_s1_agent_m0_address;                                              // rst_switch_s1_agent:m0_address -> rst_switch_s1_translator:uav_address
	wire   [3:0] rst_switch_s1_agent_m0_byteenable;                                           // rst_switch_s1_agent:m0_byteenable -> rst_switch_s1_translator:uav_byteenable
	wire         rst_switch_s1_agent_m0_read;                                                 // rst_switch_s1_agent:m0_read -> rst_switch_s1_translator:uav_read
	wire         rst_switch_s1_agent_m0_readdatavalid;                                        // rst_switch_s1_translator:uav_readdatavalid -> rst_switch_s1_agent:m0_readdatavalid
	wire         rst_switch_s1_agent_m0_lock;                                                 // rst_switch_s1_agent:m0_lock -> rst_switch_s1_translator:uav_lock
	wire  [31:0] rst_switch_s1_agent_m0_writedata;                                            // rst_switch_s1_agent:m0_writedata -> rst_switch_s1_translator:uav_writedata
	wire         rst_switch_s1_agent_m0_write;                                                // rst_switch_s1_agent:m0_write -> rst_switch_s1_translator:uav_write
	wire   [2:0] rst_switch_s1_agent_m0_burstcount;                                           // rst_switch_s1_agent:m0_burstcount -> rst_switch_s1_translator:uav_burstcount
	wire         rst_switch_s1_agent_rf_source_valid;                                         // rst_switch_s1_agent:rf_source_valid -> rst_switch_s1_agent_rsp_fifo:in_valid
	wire  [91:0] rst_switch_s1_agent_rf_source_data;                                          // rst_switch_s1_agent:rf_source_data -> rst_switch_s1_agent_rsp_fifo:in_data
	wire         rst_switch_s1_agent_rf_source_ready;                                         // rst_switch_s1_agent_rsp_fifo:in_ready -> rst_switch_s1_agent:rf_source_ready
	wire         rst_switch_s1_agent_rf_source_startofpacket;                                 // rst_switch_s1_agent:rf_source_startofpacket -> rst_switch_s1_agent_rsp_fifo:in_startofpacket
	wire         rst_switch_s1_agent_rf_source_endofpacket;                                   // rst_switch_s1_agent:rf_source_endofpacket -> rst_switch_s1_agent_rsp_fifo:in_endofpacket
	wire         rst_switch_s1_agent_rsp_fifo_out_valid;                                      // rst_switch_s1_agent_rsp_fifo:out_valid -> rst_switch_s1_agent:rf_sink_valid
	wire  [91:0] rst_switch_s1_agent_rsp_fifo_out_data;                                       // rst_switch_s1_agent_rsp_fifo:out_data -> rst_switch_s1_agent:rf_sink_data
	wire         rst_switch_s1_agent_rsp_fifo_out_ready;                                      // rst_switch_s1_agent:rf_sink_ready -> rst_switch_s1_agent_rsp_fifo:out_ready
	wire         rst_switch_s1_agent_rsp_fifo_out_startofpacket;                              // rst_switch_s1_agent_rsp_fifo:out_startofpacket -> rst_switch_s1_agent:rf_sink_startofpacket
	wire         rst_switch_s1_agent_rsp_fifo_out_endofpacket;                                // rst_switch_s1_agent_rsp_fifo:out_endofpacket -> rst_switch_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_004_src_valid;                                                       // cmd_mux_004:src_valid -> rst_switch_s1_agent:cp_valid
	wire  [90:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> rst_switch_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                       // rst_switch_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> rst_switch_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                               // cmd_mux_004:src_startofpacket -> rst_switch_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                 // cmd_mux_004:src_endofpacket -> rst_switch_s1_agent:cp_endofpacket
	...
	wire  [72:0] ocram_s1_agent_rp_data;                                                      // OCRAM_s1_agent:rp_data -> router_003:sink_data
	...
	wire         rst_switch_s1_agent_rp_valid;                                                // rst_switch_s1_agent:rp_valid -> router_006:sink_valid
	wire  [90:0] rst_switch_s1_agent_rp_data;                                                 // rst_switch_s1_agent:rp_data -> router_006:sink_data
	wire         rst_switch_s1_agent_rp_ready;                                                // router_006:sink_ready -> rst_switch_s1_agent:rp_ready
	wire         rst_switch_s1_agent_rp_startofpacket;                                        // rst_switch_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         rst_switch_s1_agent_rp_endofpacket;                                          // rst_switch_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [72:0] ocram_s1_burst_adapter_source0_data;                                         // OCRAM_s1_burst_adapter:source0_data -> OCRAM_s1_agent:cp_data
	wire         ocram_s1_burst_adapter_source0_ready;                                        // OCRAM_s1_agent:cp_ready -> OCRAM_s1_burst_adapter:source0_ready
	wire   [4:0] ocram_s1_burst_adapter_source0_channel;                                      // OCRAM_s1_burst_adapter:source0_channel -> OCRAM_s1_agent:cp_channel
	...
	wire         router_003_src_valid;                                                        // router_003:src_valid -> OCRAM_s1_rsp_width_adapter:in_valid
	wire  [72:0] router_003_src_data;                                                         // router_003:src_data -> OCRAM_s1_rsp_width_adapter:in_data
	wire         router_003_src_ready;                                                        // OCRAM_s1_rsp_width_adapter:in_ready -> router_003:src_ready
	wire   [4:0] router_003_src_channel;                                                      // router_003:src_channel -> OCRAM_s1_rsp_width_adapter:in_channel
	wire         router_003_src_startofpacket;                                                // router_003:src_startofpacket -> OCRAM_s1_rsp_width_adapter:in_startofpacket
	wire         router_003_src_endofpacket;                                                  // router_003:src_endofpacket -> OCRAM_s1_rsp_width_adapter:in_endofpacket
	wire         ocram_s1_rsp_width_adapter_src_valid;                                        // OCRAM_s1_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [90:0] ocram_s1_rsp_width_adapter_src_data;                                         // OCRAM_s1_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire         ocram_s1_rsp_width_adapter_src_ready;                                        // rsp_demux_001:sink_ready -> OCRAM_s1_rsp_width_adapter:out_ready
	wire   [4:0] ocram_s1_rsp_width_adapter_src_channel;                                      // OCRAM_s1_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire         ocram_s1_rsp_width_adapter_src_startofpacket;                                // OCRAM_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire         ocram_s1_rsp_width_adapter_src_endofpacket;                                  // OCRAM_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	wire         cmd_mux_001_src_valid;                                                       // cmd_mux_001:src_valid -> OCRAM_s1_cmd_width_adapter:in_valid
	wire  [90:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> OCRAM_s1_cmd_width_adapter:in_data
	wire         cmd_mux_001_src_ready;                                                       // OCRAM_s1_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire   [4:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> OCRAM_s1_cmd_width_adapter:in_channel
	wire         cmd_mux_001_src_startofpacket;                                               // cmd_mux_001:src_startofpacket -> OCRAM_s1_cmd_width_adapter:in_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                 // cmd_mux_001:src_endofpacket -> OCRAM_s1_cmd_width_adapter:in_endofpacket
	wire         ocram_s1_cmd_width_adapter_src_valid;                                        // OCRAM_s1_cmd_width_adapter:out_valid -> OCRAM_s1_burst_adapter:sink0_valid
	wire  [72:0] ocram_s1_cmd_width_adapter_src_data;                                         // OCRAM_s1_cmd_width_adapter:out_data -> OCRAM_s1_burst_adapter:sink0_data
	wire         ocram_s1_cmd_width_adapter_src_ready;                                        // OCRAM_s1_burst_adapter:sink0_ready -> OCRAM_s1_cmd_width_adapter:out_ready
	wire   [4:0] ocram_s1_cmd_width_adapter_src_channel;                                      // OCRAM_s1_cmd_width_adapter:out_channel -> OCRAM_s1_burst_adapter:sink0_channel
	wire         ocram_s1_cmd_width_adapter_src_startofpacket;                                // OCRAM_s1_cmd_width_adapter:out_startofpacket -> OCRAM_s1_burst_adapter:sink0_startofpacket
	wire         ocram_s1_cmd_width_adapter_src_endofpacket;                                  // OCRAM_s1_cmd_width_adapter:out_endofpacket -> OCRAM_s1_burst_adapter:sink0_endofpacket
	...
	wire         ocram_s1_agent_rdata_fifo_src_valid;                                         // OCRAM_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [17:0] ocram_s1_agent_rdata_fifo_src_data;                                          // OCRAM_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         ocram_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_001:in_0_ready -> OCRAM_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                           // avalon_st_adapter_001:out_0_valid -> OCRAM_s1_agent:rdata_fifo_sink_valid
	wire  [17:0] avalon_st_adapter_001_out_0_data;                                            // avalon_st_adapter_001:out_0_data -> OCRAM_s1_agent:rdata_fifo_sink_data
	...
	wire         rst_switch_s1_agent_rdata_fifo_src_valid;                                    // rst_switch_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] rst_switch_s1_agent_rdata_fifo_src_data;                                     // rst_switch_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         rst_switch_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_004:in_0_ready -> rst_switch_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                           // avalon_st_adapter_004:out_0_valid -> rst_switch_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                            // avalon_st_adapter_004:out_0_data -> rst_switch_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                           // rst_switch_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                           // avalon_st_adapter_004:out_0_error -> rst_switch_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) rst_switch_s1_translator (
		.clk                    (clk_100MHz_clk_clk),                      //                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (rst_switch_s1_agent_m0_address),          // avalon_universal_slave_0.address
		.uav_burstcount         (rst_switch_s1_agent_m0_burstcount),       //                         .burstcount
		.uav_read               (rst_switch_s1_agent_m0_read),             //                         .read
		.uav_write              (rst_switch_s1_agent_m0_write),            //                         .write
		.uav_waitrequest        (rst_switch_s1_agent_m0_waitrequest),      //                         .waitrequest
		.uav_readdatavalid      (rst_switch_s1_agent_m0_readdatavalid),    //                         .readdatavalid
		.uav_byteenable         (rst_switch_s1_agent_m0_byteenable),       //                         .byteenable
		.uav_readdata           (rst_switch_s1_agent_m0_readdata),         //                         .readdata
		.uav_writedata          (rst_switch_s1_agent_m0_writedata),        //                         .writedata
		.uav_lock               (rst_switch_s1_agent_m0_lock),             //                         .lock
		.uav_debugaccess        (rst_switch_s1_agent_m0_debugaccess),      //                         .debugaccess
		.av_address             (rst_switch_s1_address),                   //      avalon_anti_slave_0.address
		.av_readdata            (rst_switch_s1_readdata),                  //                         .readdata
		.av_write               (),                                        //              (terminated)
		.av_read                (),                                        //              (terminated)
		.av_writedata           (),                                        //              (terminated)
		.av_begintransfer       (),                                        //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_100MHz_clk_clk),                             //             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),        //       clk_reset.reset
		.m0_address              (rst_switch_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (rst_switch_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (rst_switch_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (rst_switch_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (rst_switch_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (rst_switch_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (rst_switch_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (rst_switch_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (rst_switch_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (rst_switch_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (rst_switch_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (rst_switch_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (rst_switch_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (rst_switch_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (rst_switch_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (rst_switch_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (rst_switch_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (rst_switch_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (rst_switch_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (rst_switch_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (rst_switch_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (rst_switch_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (rst_switch_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (rst_switch_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (rst_switch_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (rst_switch_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),              //                .error
		.rdata_fifo_src_ready    (rst_switch_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (rst_switch_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (rst_switch_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) rst_switch_s1_agent_rsp_fifo (
		.clk               (clk_100MHz_clk_clk),                             //       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
		.in_data           (rst_switch_s1_agent_rf_source_data),             //        in.data
		.in_valid          (rst_switch_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (rst_switch_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (rst_switch_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (rst_switch_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (rst_switch_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (rst_switch_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (rst_switch_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (rst_switch_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (rst_switch_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	basic_system_mm_interconnect_0_router_004 router_006 (
		.sink_ready         (rst_switch_s1_agent_rp_ready),            //      sink.ready
		.sink_valid         (rst_switch_s1_agent_rp_valid),            //          .valid
		.sink_data          (rst_switch_s1_agent_rp_data),             //          .data
		.sink_startofpacket (rst_switch_s1_agent_rp_startofpacket),    //          .startofpacket
		.sink_endofpacket   (rst_switch_s1_agent_rp_endofpacket),      //          .endofpacket
		.clk                (clk_100MHz_clk_clk),                      //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.sink0_valid           (ocram_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (ocram_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (ocram_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (ocram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (ocram_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (ocram_s1_cmd_width_adapter_src_ready),         //          .ready
	...
	basic_system_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_100MHz_clk_clk),                      //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_system_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_100MHz_clk_clk),                      //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_system_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_100MHz_clk_clk),                      //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_system_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (clk_100MHz_clk_clk),                      //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_system_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_100MHz_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.sink_ready         (ocram_s1_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (ocram_s1_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (ocram_s1_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (ocram_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (ocram_s1_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (ocram_s1_rsp_width_adapter_src_valid),         //          .valid
	...
	basic_system_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_100MHz_clk_clk),                      //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_system_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_100MHz_clk_clk),                      //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	basic_system_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (clk_100MHz_clk_clk),                      //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (ocram_s1_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (ocram_s1_rsp_width_adapter_src_data),          //          .data
		.out_channel          (ocram_s1_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (ocram_s1_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (ocram_s1_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (ocram_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (ocram_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (ocram_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (ocram_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (ocram_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (ocram_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (ocram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                        // (terminated)
	);
	...
	basic_system_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clk_100MHz_clk_clk),                      // in_clk_0.clk
		.in_rst_0_reset (nios2_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (ocram_s1_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (ocram_s1_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (ocram_s1_agent_rdata_fifo_src_ready),     //         .ready
	...
	basic_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_100MHz_clk_clk),                       // in_clk_0.clk
		.in_rst_0_reset (nios2_reset_reset_bridge_in_reset_reset),  // in_rst_0.reset
		.in_0_data      (rst_switch_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (rst_switch_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (rst_switch_s1_agent_rdata_fifo_src_ready), //         .ready
