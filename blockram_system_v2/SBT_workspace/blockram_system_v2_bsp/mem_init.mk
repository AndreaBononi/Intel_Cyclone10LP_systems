...
# Memory: instruction_OCROM
MEM_0 := blockram_system_v2_instruction_OCROM
$(MEM_0)_NAME := instruction_OCROM
...
$(MEM_0)_HIERARCHICAL_PATH := instruction_OCROM
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: instruction_OCROM
instruction_OCROM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
...
ELF_TO_HEX_CMD_NO_BOOTLOADER = $(ELF2HEX) --record=4 $(call adjust-path-mixed,$<) $(mem_start_address) $(mem_end_address) --width=$(mem_hex_width) \
